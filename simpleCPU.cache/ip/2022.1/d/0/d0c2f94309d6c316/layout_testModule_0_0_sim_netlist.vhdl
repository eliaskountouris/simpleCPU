...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_testModule is
  port (
    regSelect : out STD_LOGIC_VECTOR ( 2 downto 0 );
    WE : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_testModule is
  ...
  signal \regSelect[5]_i_1_n_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \regSelect[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \regSelect[5]_i_1\ : label is "soft_lutpair0";
begin
  regSelect(2 downto 0) <= \^regselect\(2 downto 0);
...
\regSelect[5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\regSelect_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^regselect\ : STD_LOGIC_VECTOR ( 4 downto 0 );
...
begin
  ...
  data(1) <= \<const1>\;
  data(0) <= \<const1>\;
  regSelect(5) <= \^regselect\(4);
  regSelect(4) <= \^regselect\(4);
  regSelect(3) <= \^regselect\(4);
  regSelect(2) <= \^regselect\(4);
